...
class Export {
	 ...
	 * @since 3.0.0
	 *
	 * @return string[] List of files with names as key and temporary file location as value.
	 */
	 ...
	 * @return string[] The mapping of sources to translation entries.
	 */
	 ...
	 * @since 3.0.0
	 *
	 * @param string[] $mapping A mapping of files to translation entries.
	 */
